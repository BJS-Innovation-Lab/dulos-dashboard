...
export const EVENTS: Event[] = [
  ...
  {
    id: 'asi-lo-veo-yo-wilberto',
    name: 'Así Lo Veo Yo',
    city: 'CDMX',
    venue: 'Teatro Wilberto Cantón',
    address: 'José María Velasco 59, San José Insurgentes, CDMX',
    dates: '30 Mar 2026',
    startDate: '2026-03-30',
    price: 299,
    original: 600,
    image: 'https://boletera-assets-dev.s3.us-east-2.amazonaws.com/projects/asi-lo-veo-yo/events/teatro-wilberto-canton/bf3cc9c5-9ce8-41fb-b39c-112a520c2236.jpg',
    slug: '/asi-lo-veo-yo/teatro-wilberto-canton',
    buyUrl: 'https://www.dulos.io/asi-lo-veo-yo/teatro-wilberto-canton',
    dashboardUrl: 'https://dulos-app.vercel.app/asi-lo-veo-yo/teatro-wilberto-canton',
    status: 'active',
    zones: [
      { name: 'General', price: 299, originalPrice: 600, available: 249, sold: 1, color: '#2A7AE8' },
    ],
  },
  {
