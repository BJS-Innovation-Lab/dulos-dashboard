      ...
      <section className="hp-featured-section" style={{ position: "relative", height: "80vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        ...
        <FadeIn className="section-centered">
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: "1.5rem", marginTop: "2rem" }}>
            ...
            <a href="/mijares-sinfonico/teatro-morelos-toluca" className="btn-secondary" style={{ background: "rgba(255,255,255,0.1)", border: "1px solid rgba(255,255,255,0.1)", color: "#fff", padding: "0.75rem 2rem", borderRadius: "9999px", fontSize: "14px", textDecoration: "none", transition: "all 0.3s" }}>
              Comprar Boletos
            </a>
          </div>
          </div>
          ...
          <div className="grid-events">
            {events.map((event, i) => (
              <FadeIn key={event.name} delay={i * 0.08}>
                <a href={event.url} className="event-card-link" style={{ textDecoration: "none", color: "inherit", display: "block" }}>
                  <motion.div
                    whileHover={{ y: -6 }}
      ...
      <section className="hp-featured-section" style={{ position: "relative", height: "70vh", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
        ...
        <FadeIn>
          <div style={{ position: "relative", zIndex: 10, textAlign: "center", maxWidth: "800px", margin: "0 auto", padding: "0 2rem" }}>
            ...
            <a href="/asi-lo-veo-yo/nuevo-teatro-libanes-cdmx" className="btn-primary" style={{ display: "inline-block", marginTop: "2rem", background: "#E63946", color: "#fff", padding: "1rem 2.5rem", borderRadius: "9999px", fontWeight: 500, fontSize: "14px", textDecoration: "none", transition: "all 0.3s" }}>
              Comprar Boletos
            </a>
          </div>
        </FadeIn>
